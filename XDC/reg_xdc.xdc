...
## reset (async, active-high)  (e.g., a pushbutton)
...
## write enable (e.g., a button or switch)
...
## (Removed duplicate/conflicting constraint that mapped out_b_out[3] to U18)
